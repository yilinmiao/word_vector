...
class Attention(nn.Module):
    ...
    def forward(self, q_input, v_input, k_input):
...
if __name__ == "__main__":
    ...
    k_input = torch.randn(batch_size,seq_len_kv,embed_dim)
    v_input = torch.randn(batch_size,seq_len_kv,embed_dim)
    # embedding_dim
    attn = Attention(embed_dim)

    out, weights = attn(q_input,k_input,v_input)
    # print(out)
    # print(weights)
    print(out.shape)
    print(weights.shape)
